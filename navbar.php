  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarMenu">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 main-nav-spacing">
        ...
        <?php
        $showPoultryMenu = hasPermission($_SESSION['user_type'], 'poultry_overview')
            || hasPermission($_SESSION['user_type'], 'poultry_daily_layer')
            || hasPermission($_SESSION['user_type'], 'poultry_daily_broiler')
            || hasPermission($_SESSION['user_type'], 'poultry_feeds')
            || hasPermission($_SESSION['user_type'], 'poultry_health')
            || hasPermission($_SESSION['user_type'], 'poultry_expenses');
        ?>
        ...
        <?php
        $showRuminantMenu = hasPermission($_SESSION['user_type'], 'ruminant_overview')
            || hasPermission($_SESSION['user_type'], 'ruminant_daily')
            || hasPermission($_SESSION['user_type'], 'ruminant_feeds')
            || hasPermission($_SESSION['user_type'], 'ruminant_expenses');
        ?>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <?php endif; ?>
            <?php if (isPlatformOwner() || hasRole('farm_admin') || hasPermission($_SESSION['user_type'], 'expenses')): ?>
            ...
            <?php if (isPlatformOwner() || hasRole('farm_admin') || hasPermission($_SESSION['user_type'], 'production_cycles')): ?><li><a class="dropdown-item" href="<?php echo BASE_URL; ?>/management/production_cycles.php"><i class="bi bi-arrow-repeat menu-icon me-2"></i> Production Cycles</a></li><?php endif; ?>
            <?php endif; ?>
