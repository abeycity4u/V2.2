...
function deleteFarmData(PDO $pdo, int $farmId): void {
    ...
    foreach (['sales_allocations', 'financial_allocations', 'ruminant_animal_weights', 'ruminant_health_events'] as $table) {
