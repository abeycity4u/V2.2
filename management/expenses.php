...
if ($farmType === '') {
    ...
    if ($farmType === 'general') { $whereClause .= " AND e.farm_type='general'"; }
    else { $whereClause .= " AND (e.farm_type = ? OR e.farm_type = 'both')"; $params[] = $farmType; }
}
if ($productionType !== 'all') { $whereClause .= " AND e.production_type=?"; $params[]=$productionType; }
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2 report-controls">
                            <select class="form-select" id="farmTypeFilter" style="width: 150px;">
                                ...
                                <option value="general" <?php echo $farmType==='general'?'selected':''; ?>>General</option>
                                <?php else: ?>
