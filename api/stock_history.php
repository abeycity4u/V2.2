        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped history-table mb-0" id="historyTable">
                    ...
                    <tbody>
                        <tr><td colspan="9" class="text-center text-muted">Loading history...</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
...
function renderTable(transactions) {
    ...
    if (!transactions || transactions.length === 0) {
        tbody.innerHTML = '<tr><td colspan="9" class="text-center text-muted">No history available for the selected period.</td></tr>';
        return;
    }
...
async function loadHistory(days = 30) {
    ...
    if (data.error) {
        document.querySelector('#historyTable tbody').innerHTML = `<tr><td colspan="9" class="text-danger text-center">${data.error}</td></tr>`;
        return;
    }
